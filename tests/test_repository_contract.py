...
def test_only_phase1_offline_model_training_code_is_present_for_model_gate() -> None:
    allowed_src_files = {
        ...
        "src/data/trajectory_window.py",
        "src/models/dinowm_transformer.py",
        ...
        "src/eval/dinowm_eval_offline.py",
        "src/eval/dwm_g4_planning_sanity.py",
        "src/eval/eval_rollout_libero.py",
        "src/eval/g6_representation_bottleneck.py",
        "src/eval/g7_state_action_contract.py",
        ...
        "src/planning/action_optimizer.py",
